...
You are an AI coding agent for Nodestradamus — a codebase intelligence tool providing AI assistants with deep code understanding through dependency graphs, semantic search, and impact analysis.
...
**Tech Stack:** Python 3.12+, GitHub Actions, MCP Server

**File Structure:**
- `nodestradamus/` - MCP server package (READ and WRITE)
- `scripts/` - Standalone analysis scripts (READ and WRITE)
- `tests/` - Test suite (READ and WRITE)
- `docs/` - Documentation (READ and WRITE)
...
### ✅ Always Do
- Write to `nodestradamus/`, `scripts/`, `tests/`, `.github/workflows/`
